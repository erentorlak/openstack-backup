...
- [ ] **Step 3: Implement** (gateway.py'ye ekle)
...
- [ ] **Step 2: README güncelle** (Kısayollar bölümüne ek)
...
- [ ] **Step 3: Tüm suite'i koş** (kanıt göster)
...
- [ ] **Step 5: Plan kapanışı** — bu dosyadaki tüm `- [ ]` işaretle; olası sapmaları (karar farkı, ek bulgu) ADR veya spec revizyonu olarak not et.
